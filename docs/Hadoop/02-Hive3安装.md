...
- 错误解决：==Hive3执行insert插入操作 statstask异常==
  ...
  - 现象
    ...
    ![image-20201109144915808](img/image-20201109144915808.png)
  ...
  - 开启hiveserver2执行日志。查看详细信息
    ...
    ![image-20201109145136486](img/image-20201109145136486.png)
  ...
  - 分析原因和解决
    ...
    - statstask是一个hive中用于统计插入等操作的状态任务  其返回结果如下
      ...
      ![image-20201109145304560](img/image-20201109145304560.png)
    ...
    - Hive新版本中 这是一个issues  临时解决方式如下
      ...
      ![image-20201109145621381](./img/image-20201109145621381.png)
